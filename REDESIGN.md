...
| 3b | Container CRUD (create binder/deck/graded box, move holdings between containers), quantity/condition/paid editing — unlocks manual ownership entry (Collections is intentionally read-only totals now) | organising what's owned |
